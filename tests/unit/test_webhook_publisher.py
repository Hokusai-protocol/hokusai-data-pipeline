...
class TestWebhookPublisher:
    ...
    def sample_payload(self, sample_message):
        ...
        return {
            ...
            "baseline_metrics": {
                sample_message.metric_name: sample_message.baseline_value
            },
            "metadata": {
    ...
    async def test_circuit_breaker_opens_on_failures(self, publisher, sample_payload):
        ...
        with patch.object(publisher, '_publish_with_retries', new_callable=AsyncMock) as mock_publish:
    ...
    def test_publish_sync_success(self, publisher, sample_message):
        ...
        with patch.object(publisher, '_send_with_circuit_breaker', new_callable=AsyncMock) as mock_send:
