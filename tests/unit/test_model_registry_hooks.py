...
class TestModelRegistryHooks:
    ...
    def test_explicit_proposal_identifier_is_forwarded(self, mock_publisher, mock_validator):
        """Test that an explicit proposal identifier is preserved for webhook consumers."""
        hooks = ModelRegistryHooks()
        ...
        result = hooks.on_model_registered_with_baseline(
            ...
            baseline_value=0.8,
            current_value=0.85,
            tags={"proposal_identifier": "HOK-ABC"},
        )
