...
class TestCLI:
    ...
    def test_cli_has_help(self) -> None:
...
class TestRunCommand:
    ...
    @patch("cli.Pipeline")
    def test_run_command_with_config(self, mock_pipeline) -> None:
    ...
    def test_run_command_without_config(self) -> None:
...
class TestEvaluateCommand:
    ...
    @patch("cli.Evaluator")
    def test_evaluate_command_with_required_args(self, mock_evaluator) -> None:
    ...
    def test_evaluate_command_missing_args(self) -> None:
...
class TestCompareCommand:
    ...
    def test_compare_command_with_models(self, mock_comparator) -> None:
...
class TestStatusCommand:
    ...
    def test_status_command_shows_status(self, mock_status_checker) -> None:
