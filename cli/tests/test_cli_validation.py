...
from hokusai_validate.validators import SchemaValidator, PIIDetector, DataQualityChecker
...
class TestCLI:
    ...
    def test_cli_help_text(self, cli_runner):
    ...
    def test_cli_missing_input_file(self, cli_runner):
        """Test error when no input file provided."""
        result = cli_runner.invoke(main, [])
        assert result.exit_code != 0
        assert 'Missing argument' in result.output
    
    def test_cli_nonexistent_file(self, cli_runner):
        """Test error when input file doesn't exist."""
        result = cli_runner.invoke(main, ['nonexistent.csv'])
        assert result.exit_code != 0
        assert 'does not exist' in result.output
    
    def test_cli_unsupported_format(self, cli_runner, tmp_path):
    ...
    def test_cli_successful_validation(self, cli_runner, sample_csv_file):
...
class TestFileLoader:
    ...
    def test_load_corrupted_file(self, corrupted_csv_file):
...
class TestSchemaValidator:
    ...
    def test_validate_required_columns(self, sample_dataframe):
    ...
    def test_missing_required_columns(self, sample_dataframe):
    ...
    def test_invalid_data_types(self, sample_dataframe):
...
class TestPIIDetector:
    ...
    def test_detect_email_addresses(self, dataframe_with_pii):
    ...
    def test_detect_phone_numbers(self, dataframe_with_pii):
    ...
    def test_no_pii_detection(self, sample_dataframe):
    ...
    def test_custom_pii_patterns(self, sample_dataframe):
    ...
    def test_pii_redaction(self, dataframe_with_pii):
...
class TestHashGenerator:
    ...
    def test_deterministic_hashing(self, sample_dataframe):
    ...
    def test_different_data_different_hash(self, sample_dataframe):
    ...
    def test_normalized_hashing(self, sample_dataframe):
        """Test normalized data hashing."""
        generator = HashGenerator()
        hash_normal = generator.generate(sample_dataframe)
    ...
    def test_chunked_hashing(self, large_dataframe):
...
class TestManifestGenerator:
    ...
    def test_basic_manifest_generation(self, sample_dataframe, tmp_path):
    ...
    def test_manifest_schema_validation(self, sample_manifest):
    ...
    def test_manifest_signing(self, sample_manifest):
