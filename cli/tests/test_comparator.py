...
class TestComparator:
    ...
    def test_compare_models(self, mock_evaluator_class) -> None:
    ...
    def test_compare_with_statistical_test(self) -> None:
    ...
    def test_compare_with_cross_validation(self) -> None:
    ...
    def test_compare_output_format(self) -> None:
    ...
    def test_compare_with_mlflow_logging(self, mock_mlflow) -> None:
    ...
    def test_compare_error_handling(self) -> None:
    ...
    def test_compare_identical_models(self) -> None:
