...
class TestPipeline:
    ...
    def test_pipeline_run(self, mock_evaluator, mock_model_loader, mock_data_loader) -> None:
    ...
    @patch("pipeline.DataLoader")
    def test_pipeline_error_handling(self, mock_data_loader) -> None:
    ...
    def test_pipeline_step_tracking(self) -> None:
    ...
    def test_pipeline_mlflow_tracking(self, mock_mlflow) -> None:
