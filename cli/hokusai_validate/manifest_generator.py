...
class ManifestGenerator:
    ...
    def generate(
        ...
        try:
            manifest = {
                ...
                "data_hash": data_hash,
                "contributor_metadata": self._generate_contributor_metadata(
                    contributor_metadata, eth_address,
                ),
            ...
            raise ManifestGenerationError(f"Manifest generation failed: {e!s}")
    ...
    def _generate_file_metadata(self, file_path: str, data: pd.DataFrame) -> Dict[str, Any]:
        ...
        encoding = (
            self._detect_encoding(file_path) if path.suffix.lower() in [".csv", ".json"] else None
        )
    ...
    def _generate_contributor_metadata(
        self, contributor_metadata: Optional[Dict[str, Any]], eth_address: Optional[str] = None,
    ) -> Dict[str, Any]:
    ...
    def sign(
        self, manifest: Dict[str, Any], private_key_path: Optional[str] = None,
    ) -> Dict[str, Any]:
    ...
    def save(self, manifest: Dict[str, Any], output_path: str) -> str:
        ...
        try:
            ...
            raise ManifestGenerationError(f"Failed to save manifest: {e!s}")
    ...
    def load(self, manifest_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise ManifestGenerationError(f"Failed to load manifest: {e!s}")
