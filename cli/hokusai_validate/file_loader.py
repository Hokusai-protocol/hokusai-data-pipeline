...
from .exceptions import UnsupportedFormatError, FileLoadError
...
class FileLoader:
    ...
    def load(self, file_path: str, format_type: Optional[str] = None) -> pd.DataFrame:
        ...
        try:
            ...
            if isinstance(e, (UnsupportedFormatError, FileLoadError)):
                raise
            raise FileLoadError(f"Failed to load file {file_path}: {str(e)}")
    ...
    def _load_csv(self, file_path: str) -> pd.DataFrame:
        ...
        try:
            ...
            raise FileLoadError(f"Error loading CSV file: {str(e)}")
    ...
    def _load_json(self, file_path: str) -> pd.DataFrame:
        ...
        try:
            ...
            raise FileLoadError(f"Invalid JSON file: {str(e)}")
        except Exception as e:
            raise FileLoadError(f"Error loading JSON file: {str(e)}")
    ...
    def _load_parquet(self, file_path: str) -> pd.DataFrame:
        ...
        try:
            ...
            raise FileLoadError(f"Error loading Parquet file: {str(e)}")
