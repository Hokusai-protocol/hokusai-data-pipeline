        ...
        return [
            {
                ...
                "suggestions": ["Add specific examples", "Consider job categories separately", "Include timeline evidence"]
            }
        ]
        ...
        return [
            {
                ...
                "key_points": ["15% revenue growth", "Successful product launches", "Controlled expenses", "Positive Q4 outlook"]
            }
        ]
        ...
        return [
            {
                ...
                "extraction_count": {"names": 1, "titles": 1, "organizations": 1, "dates": 1, "money": 1}
            }
        ]
