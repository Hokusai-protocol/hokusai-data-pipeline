...
class DraftText(BaseSignature):
    ...
    def get_output_fields(cls) -> list[SignatureField]:
        return [
            SignatureField(
                name="draft", description="The generated text draft", type_hint=str, required=True
            ),
            SignatureField(
                name="outline",
...
class ExpandText(BaseSignature):
    ...
    def get_input_fields(cls) -> list[SignatureField]:
        return [
            SignatureField(
                name="text", description="The text to expand", type_hint=str, required=True
            ),
            SignatureField(
        ...
        return [
            {
                ...
                "additions_summary": [
                    "Added retail example",
                    "Added financial services example",
...
class RefineText(BaseSignature):
    ...
    def get_input_fields(cls) -> list[SignatureField]:
        return [
            SignatureField(
                name="text", description="The text to refine", type_hint=str, required=True
            ),
            SignatureField(
