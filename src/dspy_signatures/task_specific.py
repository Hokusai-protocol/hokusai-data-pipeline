...
class EmailDraft(BaseSignature):
    ...
    def get_input_fields(cls) -> list[SignatureField]:
        return [
            ...
            SignatureField(
                name="subject", description="Email subject line", type_hint=str, required=True
            ),
            SignatureField(
                name="purpose",
        ...
        return [
            {
                ...
                "key_points": [
                    ...
                    "On track for Q4",
                    "Need budget approval for Phase 2",
                ],
                "tone": "professional",
                ...
                "email_body": (
                    ...
                    "an update on our Q4 project milestones.\n\n"
                    "I'm pleased to report that we have successfully completed "
                    "Milestone 1 as of last Friday. The team has done excellent work, "
                    "and we remain on track to meet all Q4 deliverables.\n\n"
                    "Looking ahead, we'll need budget approval for Phase 2 by the end "
                    "of next week to maintain our timeline. Could we schedule a brief "
...
class CodeGeneration(BaseSignature):
    ...
    def get_output_fields(cls) -> list[SignatureField]:
        return [
            SignatureField(
                name="code", description="The generated code", type_hint=str, required=True
            ),
            SignatureField(
                name="explanation",
        ...
        return [
            {
                ...
                "analysis": (
                    "Q3 2024 e-commerce performance shows strong growth "
                    "with total revenue up 23% YoY..."
                ),
                "insights": [
        ...
        return [
            {
                "data": {
                    ...
                    "completion": 75,
                    "milestones": ["Design complete", "Development 50%"],
                ...
                "report": (
                    ...
                    "## Overview\n"
                    "The website redesign project is currently 75% complete and "
                ...
                "executive_summary": (
                    "Website redesign is 75% complete with design finalized and "
                    "development underway. Project remains on budget (60% utilized) "
                    "but faces timeline pressure. Additional resources allocated to "
                    "maintain schedule."
                ),
                "table_of_contents": [
                    "Overview",
