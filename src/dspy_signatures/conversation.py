...
class GenerateFollowUp(BaseSignature):
    ...
    def get_input_fields(cls) -> list[SignatureField]:
        return [
            ...
            SignatureField(
                name="topic", description="Main topic of discussion", type_hint=str, required=True
            ),
            SignatureField(
                name="goal",
    ...
    def get_examples(cls) -> list[dict[str, Any]]:
        return [
            {
                "conversation": {
                    "user": "I'm learning web development",
                    "assistant": "That's great! Web development is a valuable skill.",
                },
        ...
        return [
            {
                ...
                "confidence": 0.95,
                "caveats": [
                    "Differences may vary with specific implementations",
