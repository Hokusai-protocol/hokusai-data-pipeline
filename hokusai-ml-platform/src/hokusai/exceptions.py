...
class NotificationError(HokusaiException):
    """Raised when the post-registration notification step fails."""
    ...
    def __init__(
        ...
        *,
        ...
        mlflow_registered: bool = True,
    ):
        super().__init__(message)
        self.status_code = status_code
        self.response_body = response_body
        self.mlflow_registered = mlflow_registered
