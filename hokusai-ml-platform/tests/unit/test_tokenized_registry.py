...
class TestTokenizedModelRegistry:
    ...
    def test_validate_hokusai_tags_missing_required(self, registry) -> None:
    ...
    def test_validate_hokusai_tags_invalid_value_type(self, registry) -> None:
    ...
    def test_validate_hokusai_tags_invalid_benchmark_value(self, registry) -> None:
    ...
    def test_get_tokenized_model(self, registry) -> None:
    ...
    def test_validate_token_id_invalid(self, registry) -> None:
