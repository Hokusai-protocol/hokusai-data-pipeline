...
class TestTokenizedRegistryIntegration:
    ...
    def test_full_tokenized_workflow(self, registry, sample_model):
    ...
    def test_multiple_versions_same_token(self, registry, mlflow_server):
    ...
    def test_update_tags_integration(self, registry, sample_model):
    ...
    def test_invalid_model_uri(self, registry):
    ...
    def test_concurrent_registrations(self, registry, mlflow_server):
...
def test_with_real_mlflow_server():
