...
def migrate_output_file(input_path: str, output_path: str, formatter: ZKCompatibleOutputFormatter) -> bool:
...
def main():
    ...
    parser.add_argument('--input-dir', default='outputs', help='Directory containing existing outputs')
    parser.add_argument('--output-dir', default='outputs', help='Directory for ZK-compatible outputs')
    parser.add_argument('--pattern', default='delta_output_*.json', help='File pattern to migrate')
    parser.add_argument('--validate-only', action='store_true', help='Only validate existing ZK outputs')
